...
class ADNIDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        try:
            ...
            group_encoded = torch.tensor(0 if group == 'CN' else 2 if group == 'AD' else 1)     # 0: CN, 1: EMCI/LMCI, 2: AD
            gender_encoded = torch.tensor(0 if gender == 'F' else 1)
            age = torch.tensor(age)

            return subject, timepoint, mri_tensor, group_encoded, gender_encoded, age
