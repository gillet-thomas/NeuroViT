...
class StructuralDataset(Dataset):
    ...
    def generate_data(self, train_path, val_path):
        ...
        # Change path to structural MRI
        df['Path_fMRI'] = df['Subject'].apply(lambda sub: f'/mnt/data/iai/datasets/fMRI_marian/structural/s{sub}.nii')
    ...
    def process_subject_data(self, subject, fmri_path, gender, age, age_group, pain_group):
        ...
        try:
            ...
            samples.append((subject, fmri_path, gender, age, age_group, pain_group))
    ...
    def __getitem__(self, idx):
        subject, fmri_path, gender, age, age_group, pain_group = self.data[idx]    # Types are str, torch.Tensor, str, str, int
        ...
        try:
            ...
            # Resize all samples to (256, 256, 160)
            if mri_tensor.shape != (256, 256, 160):
                mri_tensor = mri_tensor[:, :, 8:168]  # Crop to (256, 256, 160)
            ...
            return subject, mri_tensor, gender_encoded, age, age_encoded, pain_group
